...
func (o *BooleansColl)UnmarshalFastJSON(r *reader.Reader) (err error) {
    var key []byte
    err = r.OpenObject()
...
func (o *BooleansColl)sequenceFastJSON(r *reader.Reader, idx int) (res []BooleansColl, err error) {
    var e BooleansColl
...
func (o *BooleansColl) UnmarshalFastJSONSlice(r *reader.Reader) (res []BooleansColl, err error) {
...
func (o *IntegersColl)UnmarshalFastJSON(r *reader.Reader) (err error) {
    var key []byte
    err = r.OpenObject()
    if r.GetType() != reader.TerminatorToken {
        for err == nil {
...
func (o *IntegersColl)sequenceFastJSON(r *reader.Reader, idx int) (res []IntegersColl, err error) {
    var e IntegersColl
    if err = e.UnmarshalFastJSON(r); err == nil {
        if !r.Next() {
...
func (o *IntegersColl) UnmarshalFastJSONSlice(r *reader.Reader) (res []IntegersColl, err error) {
    if err = r.OpenArray(); err == nil {
        if res, err = o.sequenceFastJSON(r, 0); err == nil {
            err = r.CloseArray()
        }
...
func (o *UnsignedIntegersColl)UnmarshalFastJSON(r *reader.Reader) (err error) {
    var key []byte
    err = r.OpenObject()
    if r.GetType() != reader.TerminatorToken {
        for err == nil {
...
func (o *UnsignedIntegersColl)sequenceFastJSON(r *reader.Reader, idx int) (res []UnsignedIntegersColl, err error) {
...
func (o *UnsignedIntegersColl) UnmarshalFastJSONSlice(r *reader.Reader) (res []UnsignedIntegersColl, err error) {
    if err = r.OpenArray(); err == nil {
        if res, err = o.sequenceFastJSON(r, 0); err == nil {
            err = r.CloseArray()
        }
...
func (o *FloatingPointColl)UnmarshalFastJSON(r *reader.Reader) (err error) {
    var key []byte
    err = r.OpenObject()
    if r.GetType() != reader.TerminatorToken {
        for err == nil {
...
func (o *FloatingPointColl)sequenceFastJSON(r *reader.Reader, idx int) (res []FloatingPointColl, err error) {
...
func (o *FloatingPointColl) UnmarshalFastJSONSlice(r *reader.Reader) (res []FloatingPointColl, err error) {
    if err = r.OpenArray(); err == nil {
        if res, err = o.sequenceFastJSON(r, 0); err == nil {
            err = r.CloseArray()
        }
...
func (o *StringsColl)UnmarshalFastJSON(r *reader.Reader) (err error) {
    var key []byte
    err = r.OpenObject()
    if r.GetType() != reader.TerminatorToken {
        for err == nil {
...
func (o *StringsColl)sequenceFastJSON(r *reader.Reader, idx int) (res []StringsColl, err error) {
    var e StringsColl
    if err = e.UnmarshalFastJSON(r); err == nil {
        if !r.Next() {
...
func (o *StringsColl) UnmarshalFastJSONSlice(r *reader.Reader) (res []StringsColl, err error) {
    if err = r.OpenArray(); err == nil {
        if res, err = o.sequenceFastJSON(r, 0); err == nil {
            err = r.CloseArray()
        }
